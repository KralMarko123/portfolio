  ...
  return (
    <section className="intro" id="intro">
      <div className="intro-top">
        <div
          className="intro-text showAndEnterFromLeft"
          style={{ animationDelay: "0.5s" }}
        >
          <h1 className="intro-title">Hey! I'm Marko.</h1>
          <p>
            A down-to-earth and hardworking software engineer. I love working with new
            tools and thrive when given a challenge.
          </p>
          <p>
      ...
      <TbArrowNarrowDown
        className="intro-arrow showAndBob"
